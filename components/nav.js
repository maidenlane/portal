...
class Nav extends React.Component {
  render() {
    return (
      <div className="bg-green-100 header-background tracking-wide">
        <nav className="container pt-12 sm:pt-18 pb-4 sm:pb-18 px-6 mx-auto flex">
          <ul className="flex list-none items-center w-full">
            <li className="pr-6"><a className="font-bold text-lg">Maidenlane</a></li>
            {
              this.props.currentTitle !== "Portal" ?
                <>
                  ...
                  <li>
                    <a className="cursor-pointer select-none">Contact</a>
                  </li>
                </>
                :
                <></>
            ...
            <ul className="ml-auto flex list-none items-center">
              {
                this.props.currentTitle === "Portal" ?
                  ...
                  <>
                    ...
                    <li>
                      <a className="cursor-pointer select-none border-2 border-gray-900 border-solid font-bold py-2 px-4 rounded"><a href="https://freight.page.link/demo">Sign Up</a></a>
                    </li>
                  </>
              }
            </ul>
